...
export const GET_DETAIL_BY_ID = `${environment.webApiPHARMACY}` +'TransReturPenjualanObatIrna/GetDetailRefundByHeaderId';
...
export const GET_PASIEN_IRNA_OPEN = `${environment.webApiAdmisi}` +'AdmisiIrna/AdmisiPasienIrnaGetAllByDynamicFilterForFarmasi';
export const GET_DETAIL_PENJUALAN_BY_ID_REGISTER = `${environment.webApiPHARMACY}` +'TransReturPenjualanObatIrna/GetDetailPenjualanByIdRegister';
