...
export const GET_HEADER_PERSTUJUAN_BY_PARAMS = `${environment.webApiMM}` +'TransMutasi/GetHistoryPermintaanByParams'; 
export const GET_HEADER_BY_PARAMS = `${environment.webApiMM}` +'TransMutasi/GetAllByParams';
...
export const INSERT = `${environment.webApiMM}` +'TransMutasi/InsertPermintaan';
export const INSERT_PERSETUJUAN = `${environment.webApiMM}` +'TransMutasi/Insert';
...
export const GET_ITEM_BY_PARAM = `${environment.webApiMM}` +'TransMutasi/GetLookupBarangByIdStockroom';
