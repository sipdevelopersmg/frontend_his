...
export const GET_HEADER_PERSTUJUAN_BY_PARAMS = `${environment.webApiMM}` +'TransMutasiNoEd/GetHistoryPermintaanByParams'; 
export const GET_HEADER_BY_PARAMS = `${environment.webApiMM}` +'TransMutasiNoEd/GetAllByParams';
...
export const INSERT = `${environment.webApiMM}` +'TransMutasiNoEd/InsertPermintaan';
export const INSERT_PERSETUJUAN = `${environment.webApiMM}` +'TransMutasiNoEd/Insert';
...
export const GET_ITEM_BY_PARAM = `${environment.webApiMM}` +'TransMutasiNoEd/GetLookupBarangByIdStockroom';
