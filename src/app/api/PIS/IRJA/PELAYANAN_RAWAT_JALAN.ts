...
export const POST_GET_PASIEN_FOR_LOOKUP_ADMISI_NON_ANONIM = `${environment.webApiAdmisi}` + "Admisi/PersonGetPasienForLookupAdmisiWithoutAnonim";
export const POST_GET_PASIEN_FOR_LOOKUP_ADMISI_NON_ANONIM_IRNA = `${environment.webApiAdmisi}` + "Admisi/PersonGetPasienForLookupAdmisiWithoutAnonimIRNA";
...
export const GET_PRINT_BUKTI_ADMISI_RAWAT_JALAN = `${environment.webApiLaporan}` + "PIS/Bukti_Admisi_Pasien_Rawat_Jalan";
