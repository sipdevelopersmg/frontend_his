...
export const POST_SAVE_POSTING_BILLING_IRNA = `${environment.webApiBilling}` + `tarif/TransBillingIRNA/BillPostingIRNA`;
export const POST_BATAL_POSTING_BILLING_IRNA = `${environment.webApiBilling}` + `tarif/TransBillingIRNA/BillBatalPostingIRNA`;
