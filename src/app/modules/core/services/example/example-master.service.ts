...
export class ExampleMasterService {
    ...
    postExampleWithAction(
        ...
        // spinner show
        this.httpOperationService.defaultPostRequest(API.POST_ADMISI_RAWAT_JALAN, req).subscribe(
            (_result) => {
    ...
    postExample(req: exampleMasterModel) {
        return this.httpOperationService.defaultPostRequest(API.POST_ADMISI_RAWAT_JALAN, req);
    }

    getExample() {
        return this.httpOperationService.defaultGetRequest(API.POST_ADMISI_RAWAT_JALAN);
    }
}
