...
import { SetupGrupItemModel, ISetupGrupItemModel, ISetActiveSetupGrupItemModel } from '../../../models/setup-data/setup-grup-item/SetupGrupItemModel';

@Injectable({
  providedIn: 'root'
})
export class SetupGrupItemService {

    API = MM.SETUP_DATA.SETUP_GROUP_ITEM;
    ...
    */
    onGetAll(): Observable<SetupGrupItemModel> {
    ...
    */
    onPostSave(Data: ISetupGrupItemModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupGrupItemModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupGrupItemModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupGrupItemModel): Observable<any> {
