...
import { SetupTipeSupplierModel, ISetupTipeSupplierModel, ISetActiveTipeSupplierModel } from '../../../models/setup-data/setup-tipe-supplier/SetupTipeSupplier';
...
export class SetupTipeSupplierService {
    ...
    */
    onGetAll(): Observable<SetupTipeSupplierModel> {
    ...
    */
    onPostSave(Data: ISetupTipeSupplierModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupTipeSupplierModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveTipeSupplierModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveTipeSupplierModel): Observable<any> {
