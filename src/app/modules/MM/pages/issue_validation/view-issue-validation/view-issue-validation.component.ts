...
@Component({
  selector: 'app-view-issue-validation',
  templateUrl: './view-issue-validation.component.html',
  styleUrls: ['./view-issue-validation.component.css']
})
export class ViewIssueValidationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.ChildGrid = {
        ...
        columns: [
            ...
            { field: "qty_pemakaian_internal", headerText: 'Qty', headerTextAlign: 'Center', textAlign: 'Right', width: 100, format: 'N2', allowEditing: true },
