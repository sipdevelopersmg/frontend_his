...
@Component({
    selector: 'app-pulang-resep-irna',
    templateUrl: './pulang-resep-irna.component.html',
    styleUrls: ['./pulang-resep-irna.component.css']
})
export class PulangResepIrnaComponent implements OnInit {
