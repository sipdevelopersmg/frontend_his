...
@Component({
  ...
  templateUrl: './input-resep-irda.component.html',
  styleUrls: ['./input-resep-irda.component.css']
})
export class InputResepIrdaComponent implements OnInit {
 ...
 /**
  ...
  handleAddObat(FormAddObat: any): void {
      ...
      if(this.is_racikan.value && this.DataRacikan.length > 0){
        ...
        this.resepDokterIrdaService.dataSourceChildGrid.next(this.DataRacikan);
        this.DataRacikan = []
      }
