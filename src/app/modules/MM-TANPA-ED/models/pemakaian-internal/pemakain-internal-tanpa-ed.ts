...
export interface TrPemakaianInternalTanpaEdDetailInsert {
...
export interface TrPemakaianInternalTanpaEdInsert {
    ...
    details?: TrPemakaianInternalTanpaEdDetailInsert[] | null;
}