...
import { TrReturPembelianTanpaEdDetailInsert, TrReturPembelianTanpaEdInsert } from '../../models/retur-tanpa-ed/retur-pembelian-tanpa-ed';

@Injectable({
  providedIn: 'root'
})
export class ReturPembelianTanpaEdService {

  public API = MM_TANPA_ED.RETUR_TANPA_ED.RETUR_PEMBELIAN_TANPA_ED;
  public dataSource = new BehaviorSubject([]);

  private readonly _dataDetail = new BehaviorSubject<TrReturPembelianTanpaEdDetailInsert[]>([]);
  readonly dataDetail$ = this._dataDetail.asObservable();

  get dataDetail(): TrReturPembelianTanpaEdDetailInsert[] {
      return this._dataDetail.getValue();
  }

  set dataDetail(val: TrReturPembelianTanpaEdDetailInsert[]) {
  ...
  */
  ...
  addDataDetail(detail: TrReturPembelianTanpaEdDetailInsert) {
    this.dataDetail = [
        ...this.dataDetail,
        detail
    ];
  ...
  updateFromInline(index: number, data: TrReturPembelianTanpaEdDetailInsert, rowData: TrReturPembelianTanpaEdDetailInsert) {
  ...
  validasi_detail(data: TrReturPembelianTanpaEdDetailInsert){
    // let message = ''
  ...
  sum(): void {
    ...
    Insert( Data:TrReturPembelianTanpaEdInsert ): Observable<any>{
