...
import { TrPermintaanMutasiTanpaEdDetailInsert, TrPermintaanMutasiTanpaEdInsert } from '../../models/mutasi-tanpa-ed/permintaan-mutasi-tanpa-ed';

@Injectable({
  providedIn: 'root'
})
export class PermintaanMutasiTanpaEdService {

  public API = MM_TANPA_ED.MUTASI_TANPA_ED.PENGAJUAN_MUTASI_TANPA_ED;
    public dataSource = new BehaviorSubject([]);

    private readonly _dataDetail = new BehaviorSubject<TrPermintaanMutasiTanpaEdDetailInsert[]>([]);
    readonly dataDetail$ = this._dataDetail.asObservable();

    get dataDetail(): TrPermintaanMutasiTanpaEdDetailInsert[] {
        return this._dataDetail.getValue();
    }

    set dataDetail(val: TrPermintaanMutasiTanpaEdDetailInsert[]) {
    ...
    */
    ...
    addDataDetail(detail: TrPermintaanMutasiTanpaEdDetailInsert) {
        this.dataDetail = [
            ...this.dataDetail,
            detail
        ];
    ...
    updateFromInline(index: number, data: TrPermintaanMutasiTanpaEdDetailInsert, rowData: TrPermintaanMutasiTanpaEdDetailInsert) {
    ...
    Insert(Data: TrPermintaanMutasiTanpaEdInsert): Observable<any> {
