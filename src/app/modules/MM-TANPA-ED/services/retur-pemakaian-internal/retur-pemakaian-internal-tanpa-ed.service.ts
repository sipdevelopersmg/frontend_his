...
import { TrReturPemakaianInternalTanpaEdDetailInsert, TrReturPemakaianInternalTanpaEdInsert } from '../../models/pemakaian-internal/retur-pemakaian-internal-tanpa-ed';

@Injectable({
  providedIn: 'root'
})
export class ReturPemakaianInternalTanpaEdService {

  public API = MM_TANPA_ED.PEMAKAIAN_INTERNAL_TANPA_ED.TRANSRETURPEMAKAIANINTERNAL_TANPA_ED;
  public dataSource = new BehaviorSubject([]);

  private readonly _dataDetail = new BehaviorSubject<TrReturPemakaianInternalTanpaEdDetailInsert[]>([]);
  readonly dataDetail$ = this._dataDetail.asObservable();

  get dataDetail(): TrReturPemakaianInternalTanpaEdDetailInsert[] {
      return this._dataDetail.getValue();
  }

  set dataDetail(val: TrReturPemakaianInternalTanpaEdDetailInsert[]) {
  ...
  */
  ...
  addDataDetail(detail: TrReturPemakaianInternalTanpaEdDetailInsert) {
      this.dataDetail =  [
        ...this.dataDetail,
        detail
      ];
  ...
  updateFromInline(index: number, data: TrReturPemakaianInternalTanpaEdDetailInsert, rowData: TrReturPemakaianInternalTanpaEdDetailInsert) {
  ...
  Insert( Data:TrReturPemakaianInternalTanpaEdInsert ): Observable<any>{
