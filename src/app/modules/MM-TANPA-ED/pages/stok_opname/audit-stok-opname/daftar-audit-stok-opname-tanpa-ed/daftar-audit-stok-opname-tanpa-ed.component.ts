...
@Component({
  selector: 'app-daftar-audit-stok-opname-tanpa-ed',
  templateUrl: './daftar-audit-stok-opname-tanpa-ed.component.html',
  styleUrls: ['./daftar-audit-stok-opname-tanpa-ed.component.css']
})
export class DaftarAuditStokOpnameTanpaEdComponent implements OnInit {
  ...
  ngOnInit(): void {
      this.auditStokOpnameTanpaEdService.onInitList();
  }
  ...
  handlePencarianFilter(args: any) {
      this.auditStokOpnameTanpaEdService.onGetAllByParamsSource(args);
  ...
  handleClickButtonNav(args: any): void {
      switch (args) {
          case 'Add':
              this.router.navigateByUrl('dashboard/MM_TE/stok-opname/audit-stok-opname/input-stok-opname-tanpa-ed');
              break;
          case 'Edit':
              const id = this.encryptionService.encrypt(JSON.stringify(this.SelectedData.audit_stok_opname_id));
              this.router.navigate(['dashboard/MM_TE/stok-opname/audit-stok-opname/view-stok-opname-tanpa-ed', id, "GRAHCIS"]);
              break;
          case 'Delete':
