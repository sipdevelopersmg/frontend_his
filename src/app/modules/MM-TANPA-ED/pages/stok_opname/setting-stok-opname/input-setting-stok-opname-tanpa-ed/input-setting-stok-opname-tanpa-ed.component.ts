...
@Component({
  selector: 'app-input-setting-stok-opname-tanpa-ed',
  templateUrl: './input-setting-stok-opname-tanpa-ed.component.html',
  styleUrls: ['./input-setting-stok-opname-tanpa-ed.component.css']
})

export class InputSettingStokOpnameTanpaEdComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.settingStokOpnameTanpaEdService.getAllJenisSetting().subscribe((result)=>{
...
// item 
  ...
  onInsertSemuaItem():void{
    ...
    this.settingStokOpnameTanpaEdService.insertSettingSemuaItem(Data).subscribe((result)=>{
  ...
  onInsertGrup():void{
    ...
    this.settingStokOpnameTanpaEdService.insertSettingGroup(Data).subscribe((result)=>{
      this.utilityService.onShowingCustomAlert('success', 'Berhasil Tambah Data Baru', result.message)
        .then(() => {
            this.ResetFrom();
        });
  ...
  onInsertRak():void{
    ...
    this.settingStokOpnameTanpaEdService.insertSettingRak(Data).subscribe((result)=>{
      this.utilityService.onShowingCustomAlert('success', 'Berhasil Tambah Data Baru', result.message)
        .then(() => {
            this.ResetFrom();
        });
  ...
  onInsertItem():void{
    ...
    this.settingStokOpnameTanpaEdService.insertSettingItem(Data).subscribe((result)=>{
      this.utilityService.onShowingCustomAlert('success', 'Berhasil Tambah Data Baru', result.message)
        .then(() => {
            this.ResetFrom();
        });
