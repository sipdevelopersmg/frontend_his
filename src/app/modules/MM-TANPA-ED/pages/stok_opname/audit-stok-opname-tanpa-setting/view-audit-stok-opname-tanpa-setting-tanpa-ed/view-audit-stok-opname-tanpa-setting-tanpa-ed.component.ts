...
@Component({
  selector: 'app-view-audit-stok-opname-tanpa-setting-tanpa-ed',
  templateUrl: './view-audit-stok-opname-tanpa-setting-tanpa-ed.component.html',
  styleUrls: ['./view-audit-stok-opname-tanpa-setting-tanpa-ed.component.css']
})
export class ViewAuditStokOpnameTanpaSettingTanpaEdComponent implements OnInit {
  ...
  onLoadDetailData(id){
    this.auditStokOpnameTanpaSettingTanpaEdService.onGetById(id).subscribe((result)=>{
  ...
  onFinalisasi(){
    ...
    this.auditStokOpnameTanpaSettingTanpaEdService.Finalisasi({
