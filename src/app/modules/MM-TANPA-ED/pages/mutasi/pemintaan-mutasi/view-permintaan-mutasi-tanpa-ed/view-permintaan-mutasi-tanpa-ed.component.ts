...
@Component({
  selector: 'app-view-permintaan-mutasi-tanpa-ed',
  templateUrl: './view-permintaan-mutasi-tanpa-ed.component.html',
  styleUrls: ['./view-permintaan-mutasi-tanpa-ed.component.css']
})
export class ViewPermintaanMutasiTanpaEdComponent implements OnInit {
  ...
  onLoadDetailData(pemesanan_id: any) {
      this.permintaanMutasiTanpaEdService.onGetById(pemesanan_id).subscribe((result) => {
          ...
          this.permintaanMutasiTanpaEdService.setDetail(pemesanan_id);
      });
  }
