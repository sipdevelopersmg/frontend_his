...
import { SetupJenisFormulariumModel, ISetupJenisFormulariumModel, ISetActiveSetupJenisFormulariumModel } from '../../../models/formularium/SetupJenisFormularium';
...
export class SetupJenisFormulariumService {
    ...
    */
    onGetAll(): Observable<SetupJenisFormulariumModel> {
    ...
    */
    onPostSave(Data: ISetupJenisFormulariumModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupJenisFormulariumModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupJenisFormulariumModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupJenisFormulariumModel): Observable<any> {
