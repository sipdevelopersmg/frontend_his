...
import { SetupSediaanObatModel, ISetupSediaanObatModel, ISetActiveSetupSediaanObatModel } from '../../../models/formularium/SetupSediaanObat';
...
export class SetupSediaanObatService {
    ...
    */
    onGetAll(): Observable<SetupSediaanObatModel> {
    ...
    */
    onPostSave(Data: ISetupSediaanObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupSediaanObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupSediaanObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupSediaanObatModel): Observable<any> {
