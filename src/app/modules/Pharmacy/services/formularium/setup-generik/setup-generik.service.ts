...
import { SetupGenerikModel, ISetupGenerikModel, ISetActiveSetupGenerikModel } from '../../../models/formularium/SetupGenerik';
...
export class SetupGenerikService {
    ...
    */
    onGetAll(): Observable<SetupGenerikModel> {
    ...
    */
    onPostSave(Data: ISetupGenerikModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupGenerikModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupGenerikModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupGenerikModel): Observable<any> {
