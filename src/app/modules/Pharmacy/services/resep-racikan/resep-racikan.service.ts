        ...
        const ResepRacikan: ResepRacikanModel[] = [
            ...
            },
            {
                id_obat: 2, kode_obat: 'TES2', nama_obat: 'OBAT B', jumlah: 1, satuan: '', harga: 5000, diskon: 0, subtotal: 5000, detail_racikan: [
                    {
                        id_obat: 2, kode_obat: 'TES21', nama_obat: 'HOLIMOX 500 MG', satuan: '', satuan_terkecil: 'TABLET', dosis_obat: 0.5, dosis_yg_diinginkan: 0.5, jumlah: 1, harga: 2500, subtotal: 2500
                    },
                    {
                        id_obat: 2, kode_obat: 'TES22', nama_obat: 'AZOMAX 500 MG', satuan: '', satuan_terkecil: 'TABLET', dosis_obat: 0.5, dosis_yg_diinginkan: 0.5, jumlah: 1, harga: 2500, subtotal: 2500
                    }
                ]
            },
        ];
