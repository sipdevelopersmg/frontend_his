...
import { SetupGrupObatModel, ISetupGrupObatModel, ISetActiveSetupGrupObatModel } from '../../../models/setup-data/SetupGrupObat';

@Injectable({
  providedIn: 'root'
})
export class SetupGrupObatService {

    API = PHARMACY.SETUP_DATA.SETUP_GRUP_OBAT;
    ...
    */
    onGetAll(): Observable<SetupGrupObatModel> {
    ...
    */
    onPostSave(Data: ISetupGrupObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupGrupObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupGrupObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupGrupObatModel): Observable<any> {
