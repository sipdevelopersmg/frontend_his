...
import { SetupCaraPakaiObatModel, ISetupCaraPakaiObatModel, ISetActiveSetupCaraPakaiObatModel } from '../../../models/setup-data/SetupCaraPakaiObat';
...
export class SetupCaraPakaiObatService {
    ...
    API = PHARMACY.SETUP_DATA.SETUP_CARA_PAKAI_OBAT;
    ...
    */
    onGetAll(): Observable<SetupCaraPakaiObatModel> {
    ...
    */
    onPostSave(Data: ISetupCaraPakaiObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupCaraPakaiObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupCaraPakaiObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupCaraPakaiObatModel): Observable<any> {
