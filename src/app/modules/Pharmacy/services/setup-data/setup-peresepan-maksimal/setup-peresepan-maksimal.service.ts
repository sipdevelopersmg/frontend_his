...
import { ISetupPeresepanMaksimalModel, SetupPeresepanMaksimalModel } from '../../../models/setup-data/SetupPeresepanMaksimalModel';
...
export class SetupPeresepanMaksimalService {
    ...
    API = PHARMACY.SETUP_DATA.SETUP_PERESEPAN_MAKSIMAL
