...
import { ISetupRestriksiModel, SetupRestriksiModel } from '../../../models/setup-data/SetupRestriksiModel';

@Injectable({
  providedIn: 'root'
})
export class SetupRestriksiService {
    ...
    */
    onGetAll(): Observable<SetupRestriksiModel> {
    ...
    */
    onPostSave(Data: ISetupRestriksiModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupRestriksiModel): Observable<any> {
