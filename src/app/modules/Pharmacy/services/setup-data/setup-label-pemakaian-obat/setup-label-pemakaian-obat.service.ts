...
import { SetupLabelPemakaianObatModel, ISetupLabelPemakaianObatModel, ISetActiveSetupLabelPemakaianObatModel } from '../../../models/setup-data/SetupLabelPemakaianObat';

@Injectable({
  providedIn: 'root'
})
export class SetupLabelPemakaianObatService {

    API = PHARMACY.SETUP_DATA.SETUP_LABEL_PEMAKAIAN_OBAT
    ...
    */
    onGetAll(): Observable<SetupLabelPemakaianObatModel> {
    ...
    */
    onPostSave(Data: ISetupLabelPemakaianObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutEdit(Data: ISetupLabelPemakaianObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToActive(Data: ISetActiveSetupLabelPemakaianObatModel): Observable<any> {
     ...
     * @param ISetupPabrikModel
    */
    onPutToDeActive(Data: ISetActiveSetupLabelPemakaianObatModel): Observable<any> {
