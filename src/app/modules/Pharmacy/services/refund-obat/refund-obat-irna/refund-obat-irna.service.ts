...
import { TrRefundObatIrnaDetailInsert, TrRefundObatIrnaInsert } from '../../../models/refund-obat/refund-obat-irna.model';

@Injectable({
  providedIn: 'root'
})
export class RefundObatIrnaService {

  public API = PHARMACY.RETUR_PENJUALAN.RETUR_PENJUALAN_OBAT_IRNA;
  public dataSource = new BehaviorSubject([]);
  public dataTransaksiObat = new BehaviorSubject([]);

  private readonly _dataDetail = new BehaviorSubject<TrRefundObatIrnaDetailInsert[]>([]);
  readonly dataDetail$ = this._dataDetail.asObservable();

  get dataDetail(): TrRefundObatIrnaDetailInsert[] {
      return this._dataDetail.getValue();
  }

  set dataDetail(val: TrRefundObatIrnaDetailInsert[]) {
  ...
  addDataDetail(detail: TrRefundObatIrnaDetailInsert) {
      this.dataDetail =  [
          ...this.dataDetail,
          detail
      ];
  ...
  updateFromInline(index: number, data: TrRefundObatIrnaDetailInsert, rowData: TrRefundObatIrnaDetailInsert) {
  ...
  Insert( Data:TrRefundObatIrnaInsert ): Observable<any>{
