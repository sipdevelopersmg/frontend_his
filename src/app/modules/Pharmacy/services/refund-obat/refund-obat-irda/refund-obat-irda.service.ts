...
import { TrRefundObatIrdaDetailInsert, TrRefundObatIrdaInsert } from '../../../models/refund-obat/refund-obat-irda.model';

@Injectable({
  providedIn: 'root'
})
export class RefundObatIrdaService {

  public API = PHARMACY.RETUR_PENJUALAN.RETUR_PENJUALAN_OBAT_IRDA;
    public dataSource = new BehaviorSubject([]);
    public dataTransaksiObat = new BehaviorSubject([]);

    private readonly _dataDetail = new BehaviorSubject<TrRefundObatIrdaDetailInsert[]>([]);
    readonly dataDetail$ = this._dataDetail.asObservable();

    get dataDetail(): TrRefundObatIrdaDetailInsert[] {
        return this._dataDetail.getValue();
    }

    set dataDetail(val: TrRefundObatIrdaDetailInsert[]) {
    ...
    addDataDetail(detail: TrRefundObatIrdaDetailInsert) {
        this.dataDetail =  [
            ...this.dataDetail,
            detail
        ];
    ...
    updateFromInline(index: number, data: TrRefundObatIrdaDetailInsert, rowData: TrRefundObatIrdaDetailInsert) {
    ...
    Insert( Data:TrRefundObatIrdaInsert ): Observable<any>{
