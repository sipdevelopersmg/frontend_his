...
import { TrResepFormulariumDokterIrjaDetailInsert, TrResepFormulariumDokterIrjaDetailRacikanInsert } from '../../models/resep-formularium/resep-formularium';

@Injectable({
  providedIn: 'root'
})
export class ResepFormulariumIrjaService {

  private API = PHARMACY.RESEP_FORMULARIUM.RESEP_FORMULARIUM_IRJA;
