...
@Component({
  selector: 'app-refund-obat-irna-daftar',
  templateUrl: './refund-obat-irna-daftar.component.html',
  styleUrls: ['./refund-obat-irna-daftar.component.css']
})
export class RefundObatIrnaDaftarComponent implements OnInit {
