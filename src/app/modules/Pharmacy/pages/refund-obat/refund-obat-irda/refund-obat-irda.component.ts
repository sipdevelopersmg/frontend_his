...
import { AddEventArgs,EditSettingsModel, IEditCell, GridComponent, GridModel } from '@syncfusion/ej2-angular-grids';
...
@Component({
  selector: 'app-refund-obat-irda',
  templateUrl: './refund-obat-irda.component.html',
  styleUrls: ['./refund-obat-irda.component.css']
})
export class RefundObatIrdaComponent implements OnInit {
  SetupOutletDropdownField: object = { text: 'nama_outlet', value: 'id_outlet' };
  urlNoRegistrasi = PHARMACY.RETUR_PENJUALAN.RETUR_PENJUALAN_OBAT_IRDA.GET_PASIEN_IRDA;
