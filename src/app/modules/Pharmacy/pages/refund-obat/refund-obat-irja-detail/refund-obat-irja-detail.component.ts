...
@Component({
  selector: 'app-refund-obat-irja-detail',
  templateUrl: './refund-obat-irja-detail.component.html',
  styleUrls: ['./refund-obat-irja-detail.component.css']
})
export class RefundObatIrjaDetailComponent implements OnInit {
