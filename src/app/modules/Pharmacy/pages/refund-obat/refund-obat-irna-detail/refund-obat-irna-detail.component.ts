...
@Component({
  selector: 'app-refund-obat-irna-detail',
  templateUrl: './refund-obat-irna-detail.component.html',
  styleUrls: ['./refund-obat-irna-detail.component.css']
})
export class RefundObatIrnaDetailComponent implements OnInit {
