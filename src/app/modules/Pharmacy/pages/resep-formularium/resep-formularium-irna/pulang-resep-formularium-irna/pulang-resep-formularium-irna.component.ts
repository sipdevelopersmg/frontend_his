...
@Component({
    selector: 'app-pulang-resep-formularium-irna',
    templateUrl: './pulang-resep-formularium-irna.component.html',
    styleUrls: ['./pulang-resep-formularium-irna.component.css']
})
export class PulangResepFormulariumIrnaComponent implements OnInit {
