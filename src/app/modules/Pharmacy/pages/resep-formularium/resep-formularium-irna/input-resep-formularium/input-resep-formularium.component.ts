...
@Component({
    selector: 'app-input-resep-formularium',
    templateUrl: './input-resep-formularium.component.html',
    styleUrls: ['./input-resep-formularium.component.css']
})
export class InputResepFormulariumComponent implements OnInit {
    ...
    */
    ...
    public data: DataManager = new DataManager({
        ...
        url: PHARMACY.RESEP_FORMULARIUM.RESEP_FORMULARIUM_IRNA.GET_OBAT_PARAMS_DROPDOWNLIST,
