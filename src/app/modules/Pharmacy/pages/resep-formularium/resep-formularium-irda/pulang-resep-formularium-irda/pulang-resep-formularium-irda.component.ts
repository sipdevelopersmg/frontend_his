...
@Component({
    selector: 'app-pulang-resep-formularium-irda',
    templateUrl: './pulang-resep-formularium-irda.component.html',
    styleUrls: ['./pulang-resep-formularium-irda.component.css']
})
export class PulangResepFormulariumIrdaComponent implements OnInit {
