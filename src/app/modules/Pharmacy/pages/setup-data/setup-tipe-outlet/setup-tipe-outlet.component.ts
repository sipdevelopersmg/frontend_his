...
import { SetupTipeOutletModel } from '../../../models/setup-data/SetupTipeOutletModel';
import { SetupTipeOutletService } from '../../../services/setup-data/setup-tipe-outlet/setup-tipe-outlet.service';

@Component({
  selector: 'app-setup-tipe-outlet',
  templateUrl: './setup-tipe-outlet.component.html',
  styleUrls: ['./setup-tipe-outlet.component.css']
})
export class SetupTipeOutletComponent implements OnInit {
    ...
    */
    ...
    constructor(
      ...
      private setupTipeOutletService: SetupTipeOutletService
    ) {
      this.FormInputData = this.formBuilder.group({
        id_tipe_outlet: [0, []],
        tipe_outlet: ['', [Validators.required]],
    ...
    SaveAndNew(): void {
      ...
      if (this.inputFieldState=='normal') {
        this.setupTipeOutletService.onPostSave(Data)
          .subscribe((result: SetupTipeOutletModel) => {
    ...
    get tipe_outlet(): AbstractControl { return this.FormInputData.get('tipe_outlet'); }
