...
import { SetupRutePemberianObatModel } from '../../../models/setup-data/SetupRutePemberianObat';
import { SetupRutePemberianObatService } from '../../../services/setup-data/setup-rute-pemberian-obat/setup-rute-pemberian-obat.service';

@Component({
  selector: 'app-setup-rute-pemberian-obat',
  templateUrl: './setup-rute-pemberian-obat.component.html',
  styleUrls: ['./setup-rute-pemberian-obat.component.css']
})
export class SetupRutePemberianObatComponent implements OnInit {
    ...
    */
    ...
    constructor(
      ...
      private setupRutePemberianObatService: SetupRutePemberianObatService
    ) {
      this.FormInputData = this.formBuilder.group({
        id_rute_pemberian_obat: [0, []],
        nama_rute_pemberian_obat: ['', [Validators.required]],
        rute_pasien: ['', [Validators.required]],
        ordered: [0, []],
        is_parenteral: [false, []],
        is_active: [false, []]
      });
    ...
    SaveAndNew(): void {
      ...
      if (this.inputFieldState=='normal') {
        this.setupRutePemberianObatService.onPostSave(Data)
          .subscribe((result: SetupRutePemberianObatModel) => {
    ...
    */
    SetActive(is_active: boolean, id_rute_pemberian_obat: number): void {
      let data = {
    ...
    get id_rute_pemberian_obat(): AbstractControl { return this.FormInputData.get('id_rute_pemberian_obat'); }
    get nama_rute_pemberian_obat(): AbstractControl { return this.FormInputData.get('nama_rute_pemberian_obat'); }
    get rute_pasien(): AbstractControl { return this.FormInputData.get('rute_pasien'); }
    get ordered(): AbstractControl { return this.FormInputData.get('ordered'); }
    get is_parenteral(): AbstractControl { return this.FormInputData.get('is_parenteral'); }
