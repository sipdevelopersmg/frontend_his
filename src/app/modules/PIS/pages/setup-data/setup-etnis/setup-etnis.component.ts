...
import { EtnisModel } from '../../../models/setup-data/setup-etnis.model';
import { SetupEtnisService } from '../../../services/setup-data/setup-etnis/setup-etnis.service';
import * as Config from './json/setup-etnis.config.json';
...
export class SetupEtnisComponent implements OnInit {
    ...
    */
    ...
    GetAllData(): void {
        this.setupEtnisService.onGetAll()
            .subscribe((result) => {
    ...
    SaveAndNew(): void {
        ...
        if (this.inputFieldState == 'normal') {
            ...
            this.setupEtnisService.onPostSave(Data)
                .subscribe((result) => {
            ...
            this.setupEtnisService.onPutEdit(Data)
                .subscribe((result) => {
    ...
    DeleteData(): void {
        ...
        const Data: EtnisModel = this.SelectedData;

        this.setupEtnisService.onDelete(Data.id_etnis)
            .subscribe((result) => {
    ...
    get id_etnis(): AbstractControl { return this.FormInputData.get('id_etnis'); }
    get etnis(): AbstractControl { return this.FormInputData.get('etnis'); }
