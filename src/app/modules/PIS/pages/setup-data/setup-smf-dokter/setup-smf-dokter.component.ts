...
import { SmfModel } from '../../../models/setup-data/setup-smf-dokter.model';
import { SetupSmfDokterService } from '../../../services/setup-data/setup-smf-dokter/setup-smf-dokter.service';
import * as Config from './json/setup-smf-dokter.config.json';

@Component({
    selector: 'app-setup-smf-dokter',
    templateUrl: './setup-smf-dokter.component.html',
    styleUrls: ['./setup-smf-dokter.component.css']
})
export class SetupSmfDokterComponent implements OnInit {
    ...
    */
    ...
    ResetFrom(): void {
        ...
        this.kode_smf.setValue('');
        this.nama_smf.setValue('');
    }

    /** Method Untuk Mereload Data Grid */
    GetAllData(): void {
        this.setupSmfDokterService.onGetAll()
            .subscribe((result) => {
    ...
    SaveAndNew(): void {
        const Data: SmfModel = this.FormInputData.value;

        if (this.inputFieldState == 'normal') {

            Data.id_smf = 0;

            this.setupSmfDokterService.onPostSave(Data)
                .subscribe((result) => {
            ...
            this.setupSmfDokterService.onPutEdit(Data)
                .subscribe((result) => {
    ...
    DeleteData(): void {
        ...
        const Data: SmfModel = this.SelectedData;

        this.setupSmfDokterService.onDelete(Data.id_smf)
            .subscribe((result) => {
    ...
    get id_smf(): AbstractControl { return this.FormInputData.get('id_smf'); }
    get kode_smf(): AbstractControl { return this.FormInputData.get('kode_smf'); }
    get nama_smf(): AbstractControl { return this.FormInputData.get('nama_smf'); }
