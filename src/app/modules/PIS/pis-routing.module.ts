...
const pisRoutes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: "update-status-antrian-terprogram-pemesanan-bed", component: UpdateAntrianTerprogramComponent, data: { title: "Update Status Antrian Terprogram Pemesanan Bed" }, },
        ]
    },
    {
