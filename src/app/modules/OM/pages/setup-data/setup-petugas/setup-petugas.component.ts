...
import * as Config from './json/setup-petugas.config.json';

@Component({
    selector: 'app-setup-petugas',
    templateUrl: './setup-petugas.component.html',
    styleUrls: ['./setup-petugas.component.css']
})
export class SetupPetugasComponent implements OnInit {
   ...
   */
    ...
    */
    SelectedData: PetugasModel;

    KodeGrupPenunjangDatasource: any[] = [
        { text: 'LABORATORIUM', value: 'LAB' },
        { text: 'RADIOLOGI', value: 'RAD' },
    ];
    KodeGrupPenunjangFiels: object = { text: 'text', value: 'value' };
    ...
    constructor(
        ...
        this.FormInputData = this.formBuilder.group({
            id_petugas: [0, [Validators.required]],
            nama_petugas: ['', [Validators.required]],
    ...
    SetFrom(Data: PetugasModel): void {
        this.FormInputData.reset();
    ...
    SaveAndNew(): void {
        const Data: PetugasModel = this.FormInputData.value;
    ...
    DeleteData(): void {
        ...
        const Data: PetugasModel = this.SelectedData;
    ...
    get id_petugas(): AbstractControl { return this.FormInputData.get('id_petugas'); }
    get nama_petugas(): AbstractControl { return this.FormInputData.get('nama_petugas'); }
