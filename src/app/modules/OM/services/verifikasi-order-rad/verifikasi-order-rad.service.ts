...
export class VerifikasiOrderRadService {

    API_CONFIG = API_CONFIG.API_ORDER_MANAGEMENT.VERIFIKASI_ORDER_RAD;
    ...
    onPostVerifikasiOrderRAD(Data: any): Observable<HttpResponseModel> {
    ...
    onPostCancelOrderRAD(id_order_penunjang: number, reason_canceled: string): Observable<HttpResponseModel> {
